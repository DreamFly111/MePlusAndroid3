...
public class BTManager {
	...
	public final BluetoothSerialClient.BluetoothStreamingHandler mBTHandler = new BluetoothSerialClient.BluetoothStreamingHandler() {
	...
	public void enableBluetooth(Context context) {
		...
		btSet.enableBluetooth(context, new BluetoothSerialClient.OnBluetoothEnabledListener() {
			@Override
	...
	public void scanDevices(Context context) {
		BluetoothSerialClient btSet = mClient;
		btSet.scanDevices(context, new BluetoothSerialClient.OnScanListener() {
			@Override
			public void onStart() {
				Log.i(TAG, "Scanning....");
			}
	...
	public void initDeviceListDialog(Context context) {
		mContext = context;
		mDeviceArrayAdapter = new ArrayAdapter<String>(context, R.layout.item_decice);
